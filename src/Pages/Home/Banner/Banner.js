        ...
        <>
            <Carousel fade className="banner-div">
                <Carousel.Item>
                    ...
                    <Col md={7}>
                        <h1 className="heading-text"><span>ARN-Motors</span></h1>
                        <h2><span>100% trusted Bike Brand</span></h2>
                ...
                <Carousel.Item>
                    ...
                    <Col md={7}>
                        <h1 className="heading-text"><span>ARN-Motors</span></h1>
                        <h2><span>10+ year of this Bike Brand</span></h2>
                        <p>We are professional planners for your bike buying. No matter where you’re going from, we take you there. Let our experts plan your trip. Make your next trip awesome. Spreading smiles across the globe.</p>
                    </Col>
                </Row>
                </Carousel.Item>
                <Carousel.Item>
                    ...
                    <Col md={7}>
                        <h1 className="heading-text"><span>ARN-Motors</span></h1>
                        <h2><span>90% of our customer happy</span></h2>
                        <p>Let us transport you with our highly affordable and reliable bikes. Your imagination is your only limit with this new travel agency. Make your Hassle-Free travel plans now! Travel can open your mind</p>
                    </Col>
                </Row>
                </Carousel.Item>
